<%@ page language="java" contentType="text/html; charset=utf-8"
    ...
    <%@page language="java" import="model.bean.Member"%>
        ...
        <body id="top">
            ...
            <div class="bgded overlay" style="background-image: url('images/backgroundimage.jpg');">
                <!-- ################################################################################################ -->
                ...
                <div class="wrapper row3">
                    <main class="hoc container clear">
                        ...
                        <div class="content">
                            ...
                            <textarea class="textarea" name="content" rows="20" cols="70"><%=member.getContent()%></textarea>
                            <br>
                            <br>
                            <div id="comments">
                                    ...
                                    <li>
                                        <article>
                                            <header>
                                                ...
                                                <input type="date" value="<%=member.getBirthday()%>" name="birthday" />
                                            </header>
                                        </article>
                                    </li>
                                    <li>
                                        <article>
                                            ...
                                            <div class="comcont">
                                                <input type="text" value="<%=member.getPhone()%> " name="phone" />
                                            </div>
                                        </article>
                                    </li>
                                    <li>
                                        <article>
                                            ...
                                            <div class="comcont">
                                                <input type="email" value="<%=member.getEmail()%>" name="email" />
                                            </div>
                                        </article>
                                    </li>
                                    <li>
