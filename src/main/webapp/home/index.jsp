...
<html>
  ...
  <body id="top">
    <form action="Servlet" method="post">
      <div class="wrapper row0">
        <div id="topbar" class="hoc clear">
          <div class="fl_right">
            <ul>
              <li>
                <a href="index.jsp"><i class="fa fa-lg fa-home"></i></a>
              </li>
      ...
      <div
        class="bgded overlay"
        style="background-image: url('../assets/images/backgroundimage.jpg')"
      >
        <!--  -->
              ...
              <li>
                <article>
                  ...
                  <footer>
                    <a
                      class="btn inverse"
                      href="../home/PersonalDetailServlet?id=102210237"
                      >Xem thêm</a
                    >
                  </footer>
                </article>
              ...
              <li>
                <article>
                  ...
                  <footer>
                    <a
                      class="btn inverse"
                      href="../home/PersonalDetailServlet?id=102210219"
                      >Xem thêm</a
                    >
                  </footer>
                </article>
              ...
              <li>
                <article>
                  ...
                  <footer>
                    <a
                      class="btn inverse"
                      href="../home/PersonalDetailServlet?id=102210214"
                      >Xem thêm</a
                    >
                  </footer>
                </article>
              ...
              <li class="one_third first">
                <article>
                  <div>
                    ...
                    <p>
                      Mình đến với ngành này là vì bị truyền thông dụ dỗ: "Làm
                      IT lương vài ngàn $"
                    </p>
                  </div>
                  <img src="../assets/images/PhamTranThanhTruc.jpg" alt="" />
                  <footer>
                    <a href="../home/PersonalDetailServlet?id=102210237"
                      >More Details</a
                    >
                  </footer>
                </article>
              ...
              <li class="one_third">
                <article>
                  <div>
                    ...
                    <p>
                      Hiện tại mình là Ủy viên Ban chấp hành Liên chi đoàn Khoa
                      Công nghệ thông tin - Trường Đại học Bách Khoa - Đại học
                      Đà Nẵng
                    </p>
                  </div>
                  <img src="../assets/images/PhanThanhNgan.jpg" alt="" />
                  <footer>
                    <a href="../home/PersonalDetailServlet?id=102210219"
                      >More Details</a
                    >
                  </footer>
                </article>
              ...
              <li class="one_third">
                <article>
                  <div>
                    ...
                    <p>
                      Mình là người con của Quảng Bình, vì đam mê Công nghệ
                      thông tin mà tìm đến Đà Nẵng
                    </p>
                  </div>
                  <img src="../assets/images/ava3.png" alt="" />
                  <footer>
                    <a href="../home/PersonalDetailServlet?id=102210214"
                      >More Details</a
                    >
                  </footer>
                </article>
